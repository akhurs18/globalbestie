 ...
 */
export function requestPortalCode(email, customerIp) {
  return call('/api/public/portal/request-code', { method: 'POST', body: { email }, customerIp });
}

export function verifyPortalCode(email, code, customerIp) {
  return call('/api/public/portal/verify', { method: 'POST', body: { email, code }, customerIp });
}
